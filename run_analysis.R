...
temp_tr<- read.table("train/X_train.txt")
temp_tt <- read.table("test/X_test.txt")
X <- rbind(temp_tr, temp_tt)

temp_tr <- read.table("train/y_train.txt")
temp_tt <- read.table("test/y_test.txt")
Y <- rbind(temp_tr, temp_tt)

temp_tr <- read.table("train/subject_train.txt")
temp_tt <- read.table("test/subject_test.txt")
Subject <- rbind(temp_tr, temp_tt)
